...
import { getFinishedSchedule, deleteSchedule } from "../../services/api/api";
...
const FinishedList = () => {
  ...
  const exportCustomCSV = (data) => {
    ...
    link.download = "finished_schedule_data.csv";
    link.click();
  };
  const exportCSV = () => {
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      <h4 className="m-0">Finished Schedules</h4>
